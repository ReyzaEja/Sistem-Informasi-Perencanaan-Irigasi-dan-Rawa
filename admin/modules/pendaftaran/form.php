...
if ($_GET['form']=='detail') { 
	if (isset($_GET['id'])) {
	    ...
	    $query = mysqli_query($mysqli, "SELECT * FROM pendaftaran WHERE id_daftar='$_GET[id]'") 
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="profile-user-info">
					<div class="profile-info-row">
						<div style="width:200px" class="profile-info-name"></div>

						<div class="profile-info-value">
							<a style="width:100px" href="?module=pendaftaran" class="btn">Kembali</a>
						</div>
					</div>
				</div>
				<!--PAGE CONTENT ENDS-->
