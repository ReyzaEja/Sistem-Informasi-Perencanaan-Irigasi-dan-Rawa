...
// jika user sudah login, maka jalankan perintah untuk ubah password
    ...
    if (isset($_POST['simpan'])) {
        if (isset($_SESSION['id_daftar'])) {
            ...
            $sql = mysqli_query($mysqli, "SELECT password FROM pendaftaran WHERE id_daftar=$id_daftar")
            ...
            // jika input password lama sama dengan password didatabase, jalankan perintah untuk pengecekan selanjutnya
                ...
                // selain itu, jalankan perintah update password
                    ...
                    // perintah query untuk mengubah data pada tabel pendaftaran
                    $query = mysqli_query($mysqli, "UPDATE pendaftaran SET password  = '$new_pass'
