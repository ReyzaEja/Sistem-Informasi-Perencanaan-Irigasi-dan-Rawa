...
if (empty($_GET['form'])) { ?>
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<!--PAGE CONTENT BEGINS-->
				<form class="form-horizontal" role="form" action="modules/wkpl/proses.php?act=insert1" method="POST" />
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="nama_perusahaan" autocomplete="off" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea class="form-control" name="alamat_perusahaan" rows="2" required></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" class="form-control" name="kode_pos" maxlength="12" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" required />
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="telp_fax" maxlength="12" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="jenis_usaha" autocomplete="off" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea class="form-control" name="alamat_pemilik" rows="2" required></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea class="form-control" name="alamat_pengurus" rows="2" required></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								<input class="form-control date-picker" type="text" data-date-format="dd-mm-yyyy" name="tanggal_berdiri" autocomplete="off" required />
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								<input class="form-control date-picker" type="text" data-date-format="dd-mm-yyyy" name="tanggal_pindah" autocomplete="off" />
								<span class="input-group-addon">
									<i class="fa fa-calendar bigger-110"></i>
								</span>
							</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea class="form-control" name="alamat_lama" rows="2"></textarea>
						</div>
					</div>
...
elseif ($_GET['form']=='2') { ?>
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<!--PAGE CONTENT BEGINS-->
				<form class="form-horizontal" role="form" action="modules/wkpl/proses.php?act=insert2" method="POST" />
						...
						<div class="col-xs-12">
							...
							<div>
								<table id="simple-table" class="table table-striped table-bordered table-hover">
									...
									<tbody>
		                            	<tr>
											<td style="vertical-align:middle" width="80" class="center" rowspan="6">WNI</td>
											<td style="vertical-align:middle" width="140" class="center" rowspan="3">Laki-laki</td>
											<td width="160"> >= 18 th</td>
											<td class="center">
												<input type="hidden" name="kewarganegaraan[]" value="WNI" />
												<input type="hidden" name="jenis_kelamin[]" value="Laki-laki" />
												<input type="hidden" name="umur[]" value=">= 18 th" />

												<input style="border:none" type="text" name="cpuh1[]" class="input-sm col-xs-12 col-sm-12 center" maxlength="5" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" />
											</td>
											<td class="center">
												<input style="border:none" type="text" name="cpubr1[]" class="input-sm col-xs-12 col-sm-12 center" maxlength="5" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" />
											</td>
											<td class="center">
												<input style="border:none" type="text" name="cpubl1[]" class="input-sm col-xs-12 col-sm-12 center" maxlength="5" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" />
											</td>
											<td class="center">
												<input style="border:none" type="text" name="cpuh2[]" class="input-sm col-xs-12 col-sm-12 center" maxlength="5" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" />
											</td>
											<td class="center">
												<input style="border:none" type="text" name="cpubr2[]" class="input-sm col-xs-12 col-sm-12 center" maxlength="5" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" />
											</td>
											<td class="center">
												<input style="border:none" type="text" name="cpubl2[]" class="input-sm col-xs-12 col-sm-12 center" maxlength="5" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" />
											</td>
										</tr>
										<tr>
											<td> > 15 th s/d < 18 th</td>
											<td class="center">
												<input type="hidden" name="kewarganegaraan[]" value="WNI" />
												<input type="hidden" name="jenis_kelamin[]" value="Laki-laki" />
												<input type="hidden" name="umur[]" value="> 15 th s/d < 18 th" />
										...
										<tr>
											...
											<td class="center">
												<input type="hidden" name="kewarganegaraan[]" value="WNI" />
												<input type="hidden" name="jenis_kelamin[]" value="Laki-laki" />
												<input type="hidden" name="umur[]" value=">= 15 th" />
										...
										<tr>
											<td style="vertical-align:middle" class="center" rowspan="3">Wanita</td>
											<td> >= 18 th</td>
											<td class="center">
												<input type="hidden" name="kewarganegaraan[]" value="WNI" />
												<input type="hidden" name="jenis_kelamin[]" value="Wanita" />
												<input type="hidden" name="umur[]" value=">= 18 th" />
										...
										<tr>
											<td style="vertical-align:middle" class="center" rowspan="2">WNA</td>
											<td style="vertical-align:middle" class="center">Laki-laki</td>
											<td></td>
											<td class="center">
												<input type="hidden" name="kewarganegaraan[]" value="WNA" />
												<input type="hidden" name="jenis_kelamin[]" value="Laki-laki" />
										...
										<tr>
											<td style="vertical-align:middle" class="center">Wanita</td>
											<td></td>
											<td class="center">
												<input type="hidden" name="kewarganegaraan[]" value="WNA" />
												<input type="hidden" name="jenis_kelamin[]" value="Wanita" />
...
elseif ($_GET['form']=='3') { ?>
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<!--PAGE CONTENT BEGINS-->
				<form class="form-horizontal" role="form" action="modules/wkpl/proses.php?act=insert3" method="POST" />
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="sertifikat" maxlength="6" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								<input class="form-control date-picker" type="text" data-date-format="dd-mm-yyyy" name="tanggal_sertifikat" autocomplete="off" />
								<span class="input-group-addon">
									<i class="fa fa-calendar bigger-110"></i>
								</span>
							</div>
...
elseif ($_GET['form']=='4') { ?>
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<!--PAGE CONTENT BEGINS-->
				<form class="form-horizontal" role="form" action="modules/wkpl/proses.php?act=insert4" method="POST" name="frm4" />
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="upah_harian" name="upah_harian" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" onkeyup="total(this)" />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								<span class="input-group-addon">Rp</span>
								<input type="text" class="form-control" id="upah_bulanan" name="upah_bulanan" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" onkeyup="total(this)" />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								<span class="input-group-addon">Rp</span>
								<input type="text" class="form-control" id="upah_borongan" name="upah_borongan" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" onkeyup="total(this)" />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								<span class="input-group-addon">Rp</span>
								<input type="text" class="form-control" id="upah_seluruh" name="upah_seluruh" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" readonly required />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								<span class="input-group-addon">Rp</span>
								<input type="text" class="form-control" id="upah_tertinggi" name="upah_tertinggi" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" required />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								<span class="input-group-addon">Rp</span>
								<input type="text" class="form-control" id="upah_terendah" name="upah_terendah" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" required />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="pekerja_umr" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" required />
						</div>
					</div>
...
elseif ($_GET['form']=='5') { ?>
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<!--PAGE CONTENT BEGINS-->
				<form class="form-horizontal" role="form" action="modules/wkpl/proses.php?act=insert5" method="POST" />
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								<input class="form-control date-picker" type="text" data-date-format="dd-mm-yyyy" name="tanggal_jamsostek" autocomplete="off" />
								<span class="input-group-addon">
									<i class="fa fa-calendar bigger-110"></i>
								</span>
							</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="no_jamsostek" maxlength="10" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="peserta_jamsostek" maxlength="10" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" />
						</div>
					</div>
...
elseif ($_GET['form']=='6') { ?>
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<!--PAGE CONTENT BEGINS-->
				<form class="form-horizontal" role="form" action="modules/wkpl/proses.php?act=insert6" method="POST" />
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="rencana_pekerja" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="penerimaan_pekerja" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="pekerja_berhenti" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" />
						</div>
					</div>
			...
			<div class="col-xs-12">
				<div class="tabbable">
					...
					<div class="tab-content">
								...
								<div class="col-xs-12">
									...
									<div>
										<table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											<tbody>
												<?php  
												$query1 = mysqli_query($mysqli, "SELECT * FROM tenaga_kerja WHERE no_pendaftaran='$data[no_pendaftaran]'
				                            	...
				                            	<tr>
													...
													<td width="160" class="center"><?php echo $cpuh_tetap; ?></td>
													<td width="160" class="center"><?php echo $cpubr_tetap; ?></td>
													<td width="160" class="center"><?php echo $cpubl_tetap; ?></td>
													<td width="160" class="center"><?php echo $cpuh_tidak_tetap; ?></td>
													<td width="160" class="center"><?php echo $cpubr_tidak_tetap; ?></td>
													<td width="160" class="center"><?php echo $cpubl_tidak_tetap; ?></td>
													<td width="160" class="center"><?php echo $jumlah; ?></td>
												<?php  
												}
												?>
												</tr>
	                            				...
	                            				$query1 = mysqli_query($mysqli, "SELECT SUM(jumlah) as total FROM tenaga_kerja WHERE no_pendaftaran='$data[no_pendaftaran]'")
																				or die('Ada kesalahan pada query tampil data jumlah: '.mysqli_error($mysqli));
						...
						<?php  
						$query_upah = mysqli_query($mysqli, "SELECT * FROM pengupahan WHERE no_pendaftaran='$data[no_pendaftaran]'")
						...
						<div id="hal5" class="tab-pane fade">
							...
							<?php  
							$query_jamsostek = mysqli_query($mysqli, "SELECT * FROM jamsostek WHERE no_pendaftaran='$data[no_pendaftaran]'")
						...
						<div id="hal6" class="tab-pane fade">
							...
							<?php  
							$query_pelatihan = mysqli_query($mysqli, "SELECT * FROM pelatihan WHERE no_pendaftaran='$data[no_pendaftaran]'")
